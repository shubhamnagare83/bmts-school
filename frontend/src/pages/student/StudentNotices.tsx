...
export default function StudentNotices() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">School Notices & Announcements</h1>
        <p className="text-slate-500 text-sm">Official circulars and announcements for students</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <p className="text-center py-12 text-slate-500 text-sm">No announcements published.</p>
          ) : (
            <div className="space-y-4">
              {notices.map((notice) => (
                <div key={notice.id} className="p-4 border border-slate-200 rounded-xl bg-white space-y-2">
